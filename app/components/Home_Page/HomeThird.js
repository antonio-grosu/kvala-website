  ...
  return (
    <div className="flex flex-col gap-8 md:flex-row md:justify-center md:items-center md:py-28 md:px-40 py-12 px-8">
      ...
      <div className="flex flex-col md:w-1/2 w-full">
        <div className="text-2xl pb-8 font-semibold  text-center md:text-5xl md:p-4">
          <h1>Lorem Ipsum dolor met</h1>
        </div>
        <div className="md:hidden flex justify-center mb-8 md:w-1/2">
          <div className="grid justify-self-start w-44 h-44 bg-black rounded-full border-r-8 border-green-500"></div>
        </div>
      ...
      <div className="hidden md:flex justify-center w-1/2">
        <div className="grid justify-self-start w-56 h-56 bg-black rounded-full border-r-8 border-green-500"></div>
      </div>
    </div>
  );
};
